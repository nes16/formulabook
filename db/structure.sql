...
CREATE TABLE "properties" ("id" uuid, "name" varchar, "dims" varchar, "user_id" integer, "shared" boolean, "deleted" time, "lock_version" integer DEFAULT 0 NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "units" ("id" uuid, "property_id" integer, "name" varchar, "description" varchar, "system" varchar, "symbol" varchar, "approx" boolean, "factor" varchar, "shared" boolean, "user_id" integer, "deleted" time, "lock_version" integer DEFAULT 0 NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "variables" ("id" uuid, "name" varchar, "symbol" varchar, "unit_id" integer, "property_id" integer, "formula_id" integer, "deleted" time, "lock_version" integer DEFAULT 0 NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "formulas" ("id" uuid, "name" varchar, "symbol" varchar, "latex" varchar, "unit_id" integer, "property_id" integer, "shared" boolean, "user_id" integer, "deleted" time, "lock_version" integer DEFAULT 0 NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "globals" ("id" uuid, "name" varchar, "symbol" varchar, "value" varchar, "unit_id" integer, "shared" boolean, "user_id" integer, "deleted" time, "lock_version" integer DEFAULT 0 NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
