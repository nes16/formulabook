...
yy: {},
symbols_: {"error":2,"unit":3,"su":4,"EOF":5,"NUMBER":6,"SPACE":7,"SYMBOL":8,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"NUMBER",7:"SPACE",8:"SYMBOL"},
productions_: [0,[3,2],[4,4],[4,3],[4,1]],
performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
/* this == yyval */
...
break;
case 2:this.$ = {numeric:$$[$0-3], symbol:$$[$0-1], power:$$[$0]};
break;
case 3:this.$ = {numeric:$$[$0-2], symbol:$$[$0], power:null};
break;
case 4:this.$ = {numeric:$$[$0], symbol:null, power:null};
break;
}
},
table: [{3:1,4:2,6:[1,3]},{1:[3]},{5:[1,4]},{5:[2,4],7:[1,5]},{1:[2,1]},{8:[1,6]},{5:[2,3],6:[1,7]},{5:[2,2]}],
...
rules: [/^(?:(\s+))/,/^(?:([0-9]+(\.[0-9]+)?\b))/,/^(?:(([a-zA-Z][a-zA-Z]*)(_[a-zA-Z0-9]|_\{[a-zA-Z0-9]{2,}\})?))/,/^(?:(\$))/,/^(?:$)/],
conditions: {"ARRAY":{"rules":[0,1,2,3,4],"inclusive":false},"INITIAL":{"rules":[0,1,2,3,4],"inclusive":true}}
};
return lexer;
})();
parser.lexer = lexer;
